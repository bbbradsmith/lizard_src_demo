...
; Modified by Brad Smith to use a different variable name
.segment "ALIGNED"
.export getTVSystem
;.importzp nmis
.importzp nmi_count
...
; Modified by Brad Smith to guarantee alignment by other means
detect_pal_start:
...
; Modified by Brad Smith to guarantee alignment by other means
detect_pal_end:
.assert ((detect_pal_end & $FF00)=(detect_pal_start & $FF00)),error,"detect_pal code overflows page"
