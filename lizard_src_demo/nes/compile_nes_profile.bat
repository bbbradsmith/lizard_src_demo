...
md temp
del temp\main_profile.o
del temp\lizard_profile.nes
...
@IF ERRORLEVEL 1 GOTO badbuild
cc65\bin\ca65 main.s        -g -D BUILD_PROFILE -o temp\main_profile.o
@IF ERRORLEVEL 1 GOTO badbuild
...
@IF ERRORLEVEL 1 GOTO badbuild
cc65\bin\ld65 -o temp\F.profile.bin -C bank32k.cfg -m temp\F.profile.map.txt temp\ram.o temp\bankF.o temp\fixed.o temp\common.o temp\common_df.o temp\common_ef.o temp\collide.o temp\detect_pal.o temp\draw.o temp\text.o temp\main_profile.o temp\lizard.o temp\dogs2.o -Ln temp\nes.F.profile.labels.txt
@IF ERRORLEVEL 1 GOTO badbuild
...
copy /b temp\C.bin+temp\D.bin+temp\E.bin+temp\F.profile.bin temp\zCF.profile.bin
copy /b temp\z03.bin+temp\z47.bin+temp\z8B.bin+temp\zCF.profile.bin temp\lizard_profile.prg
copy /b temp\header.bin+temp\z03.bin+temp\z47.bin+temp\z8B.bin+temp\zCF.profile.bin temp\lizard_profile.nes

REM generate debug symbols
REM python symbols.py
